  ...
  <v-dialog v-model="dialog" max-width="1000px" height="500px">
    ...
    <v-card color="white" hide-overlay>
      ...
      <v-layout wrap class="ma-2">
        ...
        <v-flex lg6 class="pa-2">
          <v-text-field label="Date of Purchase" v-model="updatedDevice.dateOfPurchase"></v-text-field>
        </v-flex>

        <v-flex lg6 class="pa-2">
          <v-text-field label="Management IP" v-model="updatedDevice.managementIP"></v-text-field>
        </v-flex>
      </v-layout>
